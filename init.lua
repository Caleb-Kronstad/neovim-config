...
vim.api.nvim_set_hl(0, 'Type', { fg = '#c191ff' })
vim.api.nvim_set_hl(0, 'Typedef', { fg = '#c191ff' })
...
vim.api.nvim_set_hl(0, 'Special', { fg = '#d688d4' })
vim.api.nvim_set_hl(0, 'SpecialChar', { fg = '#d688d4' })
vim.api.nvim_set_hl(0, 'Tag', { fg = '#c191ff' })
...
vim.api.nvim_set_hl(0, '@type', { fg = '#c191ff' })
vim.api.nvim_set_hl(0, '@type.builtin', { fg = '#c191ff' })
vim.api.nvim_set_hl(0, '@storageclass', { fg = '#6c95eb' })
vim.api.nvim_set_hl(0, '@namespace', { fg = '#c191ff' })
vim.api.nvim_set_hl(0, '@function', { fg = '#39cc9b' })
...
vim.api.nvim_set_hl(0, '@field', { fg = '#e1bfff' })
vim.api.nvim_set_hl(0, '@property', { fg = '#e1bfff' })
vim.api.nvim_set_hl(0, '@constant', { fg = '#66c3cc', bold = true })
